...
const categorySummaries: CategorySummary[] = [
  ...
  {
    title: '월급·시급 환산 기준',
    description: '월급을 시급처럼 보거나 시급에서 월 예상액을 볼 때는 174시간/209시간 기준, 주휴수당 포함 여부, 실제 시프트를 먼저 구분해야 합니다.',
  },
  {
    title: '급여명세서 차이 점검',
  ...
  {
    title: '상여·비과세 수당 반영',
    description: '상여, 식대, 차량보조금, 연구수당처럼 매월 다르거나 비과세 한도가 있는 항목은 과세 대상과 실수령액 차이를 따로 확인해야 합니다.',
  },
  {
    title: '포괄임금·고정OT 확인',
    description: '포괄임금제나 고정 연장수당은 포함 시간, 통상임금 기준, 실제 초과근로, 5인 이상 여부를 분리해야 실수령액과 추가 지급 가능성을 오해하지 않습니다.',
  },
  {
    title: '근태·휴게시간 점검',
  ...
  {
    title: '결근·무급휴가 공제',
    description: '월급제라도 결근, 무급휴가, 병가, 조퇴가 있으면 정산 기간과 회사 공제 기준을 나눠 참고용 예상액으로 확인해야 합니다.',
  },
  {
    title: '급여 인상·소급 정산',
  ...
  {
    title: '급여 감액·수당 변경 동의',
    description: '기본급 감액, 고정수당 삭제, 근무시간 변경 제안은 동의 여부, 적용일, 최저임금, 주휴·가산수당, 공제 변동을 나눠 확인합니다.',
  },
  {
    title: '중도 입퇴사·일할 계산',
  ...
  {
    title: '퇴사월 마지막 급여 정산',
    description: '퇴사월에는 마지막 급여, 주휴·가산수당, 미사용 연차수당, 퇴직금, 4대보험 상실·정산 시점을 분리해 확인해야 합니다.',
  },
  {
    title: '지급 전 최종 점검',
  ...
  {
    title: '급여일 전 검산 순서',
    description: '급여 지급 직전에는 정산월, 입퇴사일, 근무시간, 주휴·가산수당, 비과세 수당, 4대보험 취득·상실 시점을 같은 순서로 맞춰야 합니다.',
  },
  {
    title: '지급 후 오류 정정',
    description: '이미 지급한 급여에 오류가 보이면 정산월, 원래 입력값, 실제 지급액, 수정 사유를 분리해 다음 지급월 반영 또는 정정 지급 여부를 검토해야 합니다.',
  },
  {
    title: '참고용 계산·공식 문의',
  ...
  {
    title: '근로자·프리랜서 구분',
    description: '4대보험 원천징수 급여인지, 사업소득·용역비 지급인지 먼저 나눠야 PayTools 계산기와 전문가 검토 경로를 올바르게 선택할 수 있습니다.',
  },
  {
    title: '개인정보 최소 입력',
  ...
  {
    title: '단기 알바·일용직 구분',
    description: '단기 근로자는 근로자성, 실제 근무일·근무시간, 휴게시간, 주휴수당 대상, 4대보험 적용 기간을 먼저 나눠야 합니다.',
  },
  {
    title: '외국인 근로자·비자 조건',
    description: '외국인 근로자나 유학생 아르바이트는 체류자격, 근로 가능 시간, 4대보험 적용 여부를 급여 계산 조건과 분리해 확인해야 합니다.',
  },
  {
    title: '여러 직원 급여 비교',
...
const answerRouteCards = [
  ...
  {
    title: '월급을 시급으로 환산',
    description: '월 고정급의 통상시급을 확인할 때는 174시간/209시간 기준과 주휴수당 포함 여부를 먼저 맞춘 뒤 계산기에서 결과를 비교합니다.',
    to: '/guide/how-to-use',
    label: '환산 기준',
  },
  {
  ...
  {
    title: '급여 감액·수당 변경 제안',
    description: '기본급 감액이나 고정수당 삭제 전에는 변경 전후 실수령액, 최저임금, 동의 여부, 적용일을 분리해 확인합니다.',
    to: '/simulation',
    label: '감액 전 비교',
  },
  {
  ...
  {
    title: '상여·비과세 수당이 있는 달',
    description: '상여나 비정기 수당이 있으면 과세 대상, 비과세 한도, 4대보험·세액 변동을 나눠 보고 특정 월 예상액은 급여 계산기에서 다시 확인합니다.',
    to: '/calculator',
    label: '수당 반영',
  },
  {
  ...
  {
    title: '급여일 전 빠른 검산',
    description: '지급일 직전에는 급여 계산기에서 월별 예상액을 본 뒤 정산월, 입퇴사일, 근무시간, 비과세 수당, 공제 조건을 FAQ 순서대로 다시 확인합니다.',
    to: '/calculator',
    label: '지급 전 검산',
  },
  {
    title: '지급 후 오류·정정 급여 확인',
    description: '이미 지급한 금액이 잘못된 것 같다면 기존 입력값, 실제 지급액, 차이 항목, 다음 지급월 반영 여부를 분리해 계산기에서 기준선을 다시 만듭니다.',
    to: '/calculator',
    label: '정정 계산',
  },
  {
  ...
  {
    title: '단기 알바·일용직 계산',
    description: '단기 근로자는 근로자성, 실제 근무일·근무시간, 휴게시간, 주휴수당 대상, 4대보험 적용 기간을 먼저 나눠 급여 계산기에서 예상액을 확인합니다.',
    to: '/calculator',
    label: '단기 급여 계산',
  },
  {
    title: '외국인 근로자·유학생 알바',
    description: '체류자격, 근로 가능 시간, 4대보험 적용 여부, 사업장 규모를 나눈 뒤 계산기는 참고용 예상액으로 사용합니다.',
    to: '/guide/insurance',
    label: '체류자격 확인',
  },
  {
    title: '직원별 급여 조건 비교',
    description: '정규직과 파트타임, 시프트 근무자가 섞여 있으면 같은 정산월, 급여유형, 근무시간, 수당, 공제 조건으로 맞춘 뒤 계산기와 시뮬레이션을 함께 봅니다.',
    to: '/simulation',
    label: '조건 비교',
  },
];
...
const FAQ = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    {
      category: '계산기 선택',
      question: '상여나 비과세 수당이 있는 달은 실수령액을 어떻게 봐야 하나요?',
      answer: '상여, 성과급, 식대, 차량보조금, 연구수당처럼 매월 다르거나 비과세 한도가 있는 항목은 기본급과 분리해 입력하는 것이 좋습니다. 상여가 있는 달은 과세 대상 금액과 원천징수 세액이 달라질 수 있고, 비과세 수당은 항목별 한도와 회사 처리 방식에 따라 실제 명세서와 차이가 날 수 있습니다. PayTools에서는 특정 월의 예상 실수령액을 참고용으로 확인하고, 실제 지급 전에는 급여명세서 항목명, 비과세 한도, 회사별 공제 기준을 함께 검토하세요.',
    },
    {
      category: '계산기 선택',
      question: '여러 직원의 급여를 비교할 때는 어떤 기준을 맞춰야 하나요?',
      answer: '같은 정산월을 기준으로 직원별 급여유형, 기본급 또는 시급, 소정근로일, 실제 근무시간, 휴게시간, 과세·비과세 수당, 부양가족 수, 4대보험 적용 여부, 사업장 규모를 먼저 맞추세요. 인상률이나 수당 배분처럼 여러 급여안을 비교할 때는 시뮬레이션에서 기준선을 보고, 개별 직원의 실제 지급 예상액은 급여 계산기에서 다시 확인하는 흐름이 안전합니다. 공개 답변에서는 직원 이름, 주민등록번호, 계좌번호, 원본 급여대장 없이 익명화한 조건만 사용하세요.',
    },
    {
      category: '계산기 선택',
    ...
    {
      category: '계산기 선택',
      question: '휴게시간은 근무시간에서 빼고 입력해야 하나요?',
      answer: '무급 휴게시간은 원칙적으로 실제 근로시간에서 제외해 입력하는 것이 안전합니다. 다만 휴게시간으로 표시되어 있어도 사용자가 자유롭게 이용하지 못하고 대기·감시·응대 의무가 계속된다면 실제 판단이 달라질 수 있습니다. 계산 전에는 근로계약서의 휴게시간, 출퇴근 기록, 실제 대기 여부, 사업장 운영 방식을 분리하고, 다툼이 있는 경우 PayTools 결과를 참고용으로만 보고 전문가 검토나 공식 상담 경로로 연결하세요.',
    },
    {
      category: '계산기 선택',
      question: '결근이나 무급휴가가 있는 달은 월급을 어떻게 확인하나요?',
      answer: '월급제라도 결근, 무급휴가, 병가, 조퇴가 있으면 정산 기간과 소정근로일, 실제 근무일, 무급 처리 시간, 주휴수당 대상 여부, 회사 공제 기준을 분리해 보세요. PayTools 계산 결과는 익명화한 조건으로 예상 실수령액을 비교하는 기준선이며, 실제 공제 가능 여부나 분쟁 판단은 근로계약서, 취업규칙, 근태기록, 전문가 검토로 확인하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
    ...
    {
      category: '계산기 선택',
      question: '급여 지급일 직전에 빠르게 검산하려면 어떤 순서가 좋나요?',
      answer: '먼저 급여 계산기에서 해당 정산월의 예상 지급 총액, 공제 총액, 실수령액을 확인하세요. 그다음 입사일·퇴사일, 실제 근무일과 휴게시간, 주휴수당 대상 여부, 연장·야간·휴일근로, 상여·비과세 수당, 4대보험 취득·상실 시점, 부양가족 수를 같은 순서로 맞춥니다. 금액이 크게 다르면 실제 지급 전에는 회사 공제 기준, 근로계약서, 근태기록, 전문가 검토로 분리하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
      question: '급여를 이미 지급한 뒤 계산 오류를 발견하면 어떻게 확인하나요?',
      answer: '먼저 정산월, 원래 입력한 급여유형과 근무시간, 실제 지급액, 오류로 의심되는 항목을 분리하세요. 다음으로 같은 조건을 급여 계산기에 다시 넣어 예상 지급 총액, 공제 총액, 실수령액 차이를 확인하고, 차이가 남으면 다음 지급월 반영, 정정 지급, 회사 공제 기준, 근로계약서와 근태기록을 함께 검토하세요. 체불, 최저임금 위반, 예외 공제처럼 판단이 필요한 경우에는 PayTools 결과를 참고용 기준선으로 두고 전문가 검토나 공식 문의로 분리하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
    ...
    {
      category: '계산기 선택',
      question: '직원 여러 명의 급여 조건을 비교할 때 무엇을 맞춰야 하나요?',
      answer: '직원별로 같은 정산월을 기준으로 급여유형, 기본급 또는 시급, 소정근로일, 실제 근무시간, 휴게시간, 과세·비과세 수당, 부양가족 수, 4대보험 적용 여부, 사업장 규모를 같은 순서로 정리하세요. 정규직과 파트타임이 섞여 있으면 주휴수당 대상 여부와 연장·야간·휴일근로 시간을 분리하고, 여러 급여안 비교는 시뮬레이션에서 기준선을 잡은 뒤 각 직원의 실제 지급액은 급여 계산기에서 다시 확인하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
      question: '직원 수가 늘어 5인 이상 사업장이 되는 달에는 무엇이 달라지나요?',
      answer: '직원 수가 5인 이상 기준에 가까워지는 달에는 상시근로자 수 산정 기간, 정산월, 실제 근무일, 휴게시간, 연장·야간·휴일근로 발생 여부를 먼저 분리하세요. 최저임금과 주휴수당은 사업장 규모와 무관하게 확인해야 하지만, 연장·야간·휴일 가산수당 적용 방식은 5인 이상 여부에 따라 달라질 수 있습니다. PayTools에서는 사업장 규모를 입력값으로 맞춘 뒤 급여 계산기와 연장·야간·휴일수당 가이드를 함께 확인하는 흐름이 안전합니다.',
    },
    {
      category: '계산기 선택',
    ...
    {
      category: '계산기 선택',
      question: '기본급 감액이나 고정수당 삭제를 제안받으면 무엇부터 확인해야 하나요?',
      answer: '먼저 변경 전 급여와 변경 후 급여, 적용일, 근무시간, 고정수당 삭제 여부, 동의 절차를 분리하세요. 감액 후에도 2026년 최저임금, 주휴수당, 연장·야간·휴일수당, 4대보험·소득세 공제까지 함께 확인해야 실수령액 차이를 볼 수 있습니다. PayTools에서는 시뮬레이션으로 변경 전후 기준선을 비교하고, 실제 동의 효력이나 불이익 변경 판단은 근로계약서·취업규칙·전문가 검토로 분리하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
    ...
    {
      category: '계산기 선택',
      question: '프리랜서나 개인사업자에게 지급하는 보수도 급여 계산기로 계산하나요?',
      answer: '먼저 실제 관계가 근로계약에 따른 근로자 급여인지, 사업소득·용역비 지급인지 구분해야 합니다. PayTools 급여 계산기는 월급제·시급제 근로자의 4대보험, 소득세, 주휴수당, 가산수당을 참고용으로 계산하는 흐름에 맞습니다. 프리랜서·개인사업자 보수처럼 3.3% 원천징수, 세금계산서, 용역계약, 플랫폼 수수료가 핵심인 경우에는 계산 결과를 직원 급여로 단정하지 말고 계약 형태와 세무·노무 전문가 검토를 함께 확인하세요.',
    },
    {
      category: '계산기 선택',
      question: '단기 알바나 일용직도 PayTools로 계산할 수 있나요?',
      answer: '단기 근로자는 먼저 근로계약에 따른 근로자인지, 용역·사업소득 지급인지 구분해야 합니다. 근로자라면 시급, 실제 근무일과 근무시간, 무급 휴게시간, 주휴수당 대상 여부, 사업장 규모, 4대보험 적용 기간을 나눠 급여 계산기에서 예상액을 확인하세요. 일용근로소득세, 고용보험, 산재보험처럼 별도 판단이 필요한 항목은 계산 결과를 참고용으로 보고 실제 지급 전 전문가 검토를 함께 진행하는 것이 안전합니다.',
    },
    {
      category: '계산기 선택',
      question: '외국인 근로자나 유학생 아르바이트 급여도 계산할 수 있나요?',
      answer: '근로계약에 따른 근로자 급여라면 PayTools에서 월급·시급, 근무시간, 주휴수당, 4대보험 공제 예상액을 참고용으로 확인할 수 있습니다. 다만 외국인 근로자와 유학생은 체류자격, 근로 가능 시간, 국민연금·고용보험 등 보험 적용 여부가 달라질 수 있으므로 비자 종류, 사업장 규모, 실제 근무시간을 분리하고, 체류자격·취업 가능 여부나 실제 공제 판단은 출입국·노무 전문가 검토로 연결하세요.',
    },
    // 기본급 및 수당
    {
      category: '기본급 및 수당',
    ...
    {
      category: '기본급 및 수당',
      question: '포괄임금제나 고정OT가 있으면 PayTools에 어떻게 입력하나요?',
      answer: '포괄임금제나 고정 연장수당이 있는 경우에는 기본급, 고정OT 또는 고정수당, 포함된 연장·야간·휴일근로 시간, 실제 초과근로 시간을 분리해 보세요. 포함 시간이 명확하지 않거나 실제 근로시간이 고정OT를 넘는다면 실수령액 계산만으로 추가 지급 여부를 단정하지 말고, 근로계약서·출퇴근 기록·사업장 규모와 전문가 검토를 함께 확인하는 것이 안전합니다.',
    },
    {
      category: '기본급 및 수당',
    ...
    {
      category: '4대 보험',
      question: '퇴사월에는 4대보험 상실 시점 때문에 실수령액이 달라질 수 있나요?',
      answer: '네. 퇴사월에는 건강보험·국민연금·고용보험 상실일, 정산월, 마지막 근무일, 보수월액 변경, 회사별 공제 반영 시점에 따라 공제액과 실수령액이 달라질 수 있습니다. 마지막 급여를 볼 때는 기본급·수당·주휴·가산수당과 별도로 4대보험 상실·정산 시점을 확인하고, PayTools 계산값은 참고용 기준선으로 둔 뒤 실제 공단 처리와 회사 급여 기준을 함께 검토하세요.',
    },
    {
      category: '4대 보험',
    ...
    {
      category: '법적 권리',
      question: '퇴사월 마지막 급여와 미사용 연차수당은 같이 계산하나요?',
      answer: '퇴사월에는 마지막 월급을 먼저 정산 기간, 실제 근무일, 결근·지각·조퇴, 주휴수당, 연장·야간·휴일수당으로 나눠 확인하고, 미사용 연차수당은 남은 연차일수와 통상임금을 기준으로 별도 항목처럼 점검하는 것이 안전합니다. 퇴직금, 4대보험 상실 시점, 세액 정산까지 함께 얽히면 PayTools 결과는 참고용 기준선으로 보고 근로계약서, 근무기록, 회사 규정 또는 전문가 검토를 함께 확인하세요.',
    },
    {
      category: '법적 권리',
  ...
  const faqStructuredData = [
    {
      ...
      "description": "2026년 급여 계산, 급여유형 선택, 4대보험, 공제액 변동, 실수령액, 주휴수당, 최저임금, 수습기간 감액, 급여 감액·수당 변경, 입사월 첫 월급, 급여명세서 차이, 연장·야간·휴일수당, 근로자 권리 질문을 정리한 PayTools FAQ입니다.",
      "isPartOf": {
        "@type": "WebSite",
        "name": "PayTools",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="2026년 급여 계산, 급여유형 선택, 4대보험 공제액 변동, 퇴사월 상실 시점, 실수령액, 주휴수당, 최저임금, 수습기간 감액, 급여 감액·수당 변경, 포괄임금·고정OT, 급여명세서 차이 질문을 확인하세요." />
        <link rel="canonical" href="https://paytools.work/faq" />
        <meta property="og:title" content="2026년 급여 계산 FAQ | 4대보험·실수령액·주휴수당 | PayTools" />
        <meta property="og:description" content="2026년 급여 계산과 급여유형 선택, 4대보험 공제액 변동, 퇴사월 상실 시점, 주휴수당, 최저임금, 수습기간 감액, 급여 감액·수당 변경, 포괄임금·고정OT, 급여명세서 차이를 정리한 FAQ 페이지입니다." />
        <meta property="og:url" content="https://paytools.work/faq" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="2026년 급여 계산 FAQ | PayTools" />
        <meta name="twitter:description" content="급여유형 선택, 실수령액, 4대보험 공제액 변동, 퇴사월 상실 시점, 주휴수당, 최저임금, 수습기간 감액, 급여 감액·수당 변경, 포괄임금·고정OT 질문을 확인하세요." />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8 rounded-2xl border border-blue-100 bg-blue-50/70 p-5" aria-labelledby="faq-summary-title">
            ...
            <p className="text-sm text-gray-700 mb-4">
              PayTools FAQ는 2026년 기준 급여유형 선택, 실수령액, 4대보험 공제액 변동, 소득세, 주휴수당, 최저임금, 수습기간 감액 조건, 급여 감액·수당 변경, 입사월 첫 월급, 급여명세서 차이, 연장·야간·휴일수당, 개인정보 최소 입력 원칙과 계산 결과의 참고용 한계를 빠르게 확인하도록 정리했습니다.
            </p>
