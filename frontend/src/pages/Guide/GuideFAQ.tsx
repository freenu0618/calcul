...
const CATEGORIES = ['전체', '급여유형', '시프트', '수당', '보험·세금', '정산'];
...
const FAQ_ITEMS: FAQItem[] = [
  ...
  {
    category: '급여유형',
    q: '시급 계약인데 월 보장액이 있으면 어떻게 입력하나요?',
    a: '"시급기반 월급제"를 선택하고 시급과 계약 월급(보장액)을 함께 입력하세요. 실제 시프트를 넣으면 시급 기준 계산액과 보장 월급을 비교할 수 있고, 주휴수당·연장·야간·휴일수당 조건은 별도로 확인하는 것이 안전합니다.',
  },
  {
    category: '시프트',
    q: '시프트를 꼭 입력해야 하나요?',
  ...
  {
    category: '수당',
    q: '포괄임금제나 고정OT는 어떻게 입력해야 하나요?',
    a: '기본급과 고정 연장수당 또는 고정수당을 분리하고, 포함된 연장·야간·휴일근로 시간과 실제 초과근로 시간을 따로 확인하세요. 포함 시간이 불명확하거나 실제 근로시간이 고정OT 범위를 넘으면 PayTools 결과는 참고용 예상액으로 보고 근로계약서, 출퇴근 기록, 사업장 규모, 전문가 검토를 함께 확인하는 것이 안전합니다.',
  },
  {
    category: '보험·세금',
    q: '4대보험은 어떻게 계산되나요?',
  ...
  {
    category: '정산',
    q: '월 중간에 입사하거나 퇴사한 달도 계산할 수 있나요?',
    a: '가능합니다. 먼저 정산 기간, 입사일 또는 퇴사일, 급여유형, 실제 근무일과 근무시간, 주휴수당 대상 여부를 나눠 입력하세요. 월급제는 회사의 일할 계산 기준에 따라 실제 지급액이 달라질 수 있으므로 PayTools 결과는 참고용 예상액으로 보고, 최종 지급 기준은 근로계약서와 회사 규정 또는 전문가 검토로 확인하는 것이 안전합니다.',
  },
];
