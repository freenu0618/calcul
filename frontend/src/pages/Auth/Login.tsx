          ...
          <Card title="로그인">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <a
                  href={`${API_CONFIG.BASE_URL}/oauth2/authorization/kakao`}
                  className="flex items-center justify-center w-full px-4 py-2 border border-yellow-400 rounded-md shadow-sm text-sm font-medium text-gray-900 hover:brightness-95"
                ...
                <a
                  href={`${API_CONFIG.BASE_URL}/oauth2/authorization/naver`}
                  className="flex items-center justify-center w-full px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white hover:brightness-95"
