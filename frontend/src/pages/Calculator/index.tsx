...
const calculatorInputChecklist = [
  ...
  ['근무일·근무시간·휴게시간', '소정근로일, 일 근무시간, 정산 기간, 실제 시프트, 무급 휴게시간, 주 15시간 이상 여부'],
...
const resultReviewChecklist = [
  ...
  {
    title: '주휴·가산수당 조건',
    body: '주 15시간, 소정근로일 개근, 무급 휴게시간 제외 여부, 야간·휴일근로 시간, 5인 이상 여부를 결과 해석 전에 다시 확인하세요.',
  },
  {
    title: '급여대장 저장 전',
...
const calculatorAnswerGuidance = [
  ...
  },
  {
    ...
    body: '환산시급, 주휴수당, 가산수당을 따로 확인하되 실제 위반 판단은 근로시간·휴게시간·대기시간·계약 조건을 함께 검토해야 합니다.',
  },
];
  ...
  },
  {
    ...
    step: [
      ...
      },
      {
        ...
        position: 3,
        name: '근무시간과 결과 확인',
        text: '정산 기간, 시프트, 무급 휴게시간을 확인한 뒤 지급 총액, 공제 총액, 실수령액을 검토합니다.',
        url: 'https://paytools.work/calculator',
      },
    ],
  },
  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '비과세 수당, 회사별 공제, 상여·식대·교통비 처리 방식, 정산 기간, 급여유형, 근태기록, 무급 휴게시간, 주휴·가산수당 조건이 입력값과 실제 지급 기준에서 같은지 먼저 확인해야 합니다.',
        },
      },
      {
        '@type': 'Question',
        name: '휴게시간과 대기시간이 있으면 어떻게 입력해야 하나요?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: '무급 휴게시간은 근로시간에서 제외해 입력하는 것이 원칙이지만, 자유롭게 이용하지 못하는 대기·감시·응대 시간이었는지는 근무기록, 계약서, 사업장 운영 방식에 따라 달라질 수 있어 참고용 계산 후 전문가 검토로 분리하는 것이 안전합니다.',
        },
      },
      {
        '@type': 'Question',
        name: '월 중간에 입사하거나 퇴사한 달도 계산할 수 있나요?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: '가능합니다. 정산 기간, 입사일 또는 퇴사일, 급여유형, 실제 근무일과 근무시간, 주휴수당 대상 여부를 먼저 나눠 입력하세요. 월급제는 회사의 일할 계산 기준에 따라 차이가 날 수 있으므로 PayTools 결과는 참고용 예상액으로 보고 실제 지급 기준은 근로계약서와 회사 규정 또는 전문가 검토로 확인하는 것이 안전합니다.',
        },
      },
      {
        '@type': 'Question',
        name: '상여나 비과세 수당이 있는 달은 어떻게 계산하나요?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: '상여, 성과급, 식대, 차량보조금처럼 매월 다르거나 비과세 한도가 있는 항목은 기본급과 분리해 입력하세요. 상여가 있는 달은 과세 대상 금액과 원천징수 세액이 달라질 수 있고, 비과세 수당은 항목별 한도와 회사 처리 방식에 따라 실제 명세서와 차이가 날 수 있습니다.',
        },
      },
    ],
  },
