...
const ROUTES = [
  ...
  // 가이드
  { path: '/guide', title: '급여 계산 가이드 - 사용법, 4대보험, 소득세, 수당 | PayTools', description: '급여유형 선택, 계산 전 체크리스트, 실수령액 역산, 2026년 4대보험·소득세·주휴수당·가산수당 기준과 상황별 추천 경로를 한곳에서 확인하세요.' },
  ...
  { path: '/guide/tax', title: '소득세 계산법 | 간이세액표 활용 가이드 | PayTools', description: '근로소득세 간이세액표와 부양가족 공제를 활용한 소득세 계산 방법. 2026년 세율, 원천징수 방법 안내.' },
  ...
  { path: '/guide/how-to-use', title: '서비스 사용법 - PayTools 급여 계산기', description: 'PayTools 급여 계산기를 급여유형별로 어떻게 사용하는지 안내합니다. 월급제, 시급제, 시급기반 월급제와 174시간/209시간 기준 선택법.' },
  ...
  // FAQ
  { path: '/faq', title: '2026년 급여 계산 FAQ | 4대보험·실수령액·주휴수당 질문 모음 | PayTools', description: '2026년 급여 계산, 4대보험 공제액 변동, 퇴사월 상실 시점, 실수령액, 주휴수당, 최저임금, 수습기간 감액, 급여 감액·수당 변경, 포괄임금·고정OT, 급여명세서 차이를 확인하세요.' },
