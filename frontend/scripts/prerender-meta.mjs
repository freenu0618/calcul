...
const ROUTES = [
  ...
  // FAQ
  { path: '/faq', title: '2026년 급여 계산 FAQ | 4대보험·실수령액·주휴수당 질문 모음 | PayTools', description: '2026년 급여 계산, 4대보험 공제액 변동, 퇴사월 상실 시점, 실수령액, 주휴수당, 최저임금, 수습기간 감액, 포괄임금·고정OT, 급여명세서 차이를 확인하세요.' },
